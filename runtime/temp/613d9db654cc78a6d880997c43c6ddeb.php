<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:96:"/Users/liudanfeng/Documents/www/apidoctool/public/../application/admin/view/admin/adddocapi.html";i:1541989792;s:84:"/Users/liudanfeng/Documents/www/apidoctool/application/admin/view/layouts/admin.html";i:1541989792;s:49:"../application/admin/view/layouts/htmlheader.html";i:1541989792;s:49:"../application/admin/view/layouts/mainheader.html";i:1541989792;s:45:"../application/admin/view/layouts/menuer.html";i:1541989792;s:49:"../application/admin/view/layouts/htmlfooter.html";i:1541989792;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<meta charset="UTF-8">
        ...
        <div class="box-body">
            ...
            <div class="form-group" style="padding-top:10px;width:40%;float: left">
                ...
                <select class="form-control" id="apirequest" name="apirequest" style="width:55%;float:left">
                    ...
                    <option value="3" <?php echo !empty($docapi)?$docapi['api_request']==3 ? 'selected' : '':''; ?>>DELETE</option>
                </select>
            </div>
            ...
            <div class="form-group" style="padding-top:10px;">
                ...
                <table class="table table-hover dataTable" >
                    ...
                    <?php foreach($docapi['state_codes'] as $statecode): ?>
                    <tr>
                        <td><input type='text' name='statename[]' value="<?php echo $statecode['state_name']; ?>" class='form-control' placeholder='状态值'/></td>
                        <td><input type='text' name='stateinfo[]' value="<?php echo $statecode['state_info']; ?>"  class='form-control' placeholder='状态描述'/></td>
                        <td><input type='text' name='statereason[]' value="<?php echo $statecode['state_reason']; ?>" class='form-control' placeholder='出现原因' /></td>
                        <td><input type='text' name='statesolution[]' value="<?php echo $statecode['state_solution']; ?>" class='form-control' placeholder='解决方案'/></td>
