<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"/Users/liudanfeng/Documents/www/apidoctool/public/../application/index/view/index/index.html";i:1503300356;}*/ ?>
...
<head>
    ...
    <script type="text/javascript" src="/static/home/js/mt.js"></script>
    <title>刘小莫的个人网站 - Liu Xiaomo's Personal Website</title>
    <style>
        html{
            width:100%;
            height: 100%;
        ...
        body{
            ...
            width:100%;
            height:100%;
            background-image:url(/static/home/images/pub_0.png);
        ...
        <div id="header">
            <div id="header-inner">
                <div id="header-content" onclick="backgroundImage();return false;">
                    <h1>刘小莫的个人网站</h1>
                    <p>Liu Xiaomo's Personal Website</p>
                </div>
            </div>
        </div>
                ...
                <div id="alpha">
                    <div id="alpha-inner">
                        <div id="page-alpha"    style="margin-bottom:2em;">
                            <p>» <a href="blog/">Blog</a> / <a href="/aboutme">About</a></p>
                        </div>
                    </div>
                </div>
        ...
        <div id="footerindex">
            <div id="footer-inner">
                <div id="footer-content">
                    <p><a href="#">Contact</a> | liuxiaomo.cn<span id="img_placer"></span> </p>
                </div>
            </div>
        </div>
        <!--首页页脚end-->
...
<script>
    ...
    function backgroundImage(){
        var pub_img_path='https://liuxiaomo.cn/homeback/';
        var pub_img_num = 43;

        var pub_img_current_no=function(){return Math.floor(Math.random()*pub_img_num+1);};

        var pub_img_url=function(){return pub_img_path+pub_img_current_no()+'.jpg';};
